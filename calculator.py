...
def buttonadd():
    ...
    if math=="add":
        ...
        e.insert(0,fnum**int(secondnum))
#functions that calculate global is used to access another functions
def sub():
    firstnum=e.get()
    global fnum
    global math
...
button1=Button(root,text="2",padx=40,pady=20,command=lambda:buttonclick(2))
button1=Button(root,text="3",padx=40,pady=20,command=lambda:buttonclick(3))
button1=Button(root,text="4",padx=40,pady=20,command=lambda:buttonclick(4))
button1=Button(root,text="5",padx=40,pady=20,command=lambda:buttonclick(5))
button1=Button(root,text="6",padx=40,pady=20,command=lambda:buttonclick(6))
button1=Button(root,text="7",padx=40,pady=20,command=lambda:buttonclick(7))
button1=Button(root,text="8",padx=40,pady=20,command=lambda:buttonclick(8))
button1=Button(root,text="9",padx=40,pady=20,command=lambda:buttonclick(9))
button1=Button(root,text="0",padx=40,pady=20,command=lambda:buttonclick(0))
